...
--
-- Servidor: localhost
-- Tiempo de generación: 29-01-2024 a las 04:57:18
...
CREATE TABLE `EXCURSION` (
  ...
  `FEC_INICIO` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `FEC_FIN` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `DURACION` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `HISTORIALVIAJES`
  ADD CONSTRAINT `HISTORIALVIAJES_ibfk_1` FOREIGN KEY (`ID_USUARIO`) REFERENCES `USUARIOS` (`ID`),
  ADD CONSTRAINT `HISTORIALVIAJES_ibfk_2` FOREIGN KEY (`ID_VIAJE`) REFERENCES `VIAJES` (`ID`);
...
ALTER TABLE `VIAJES`
  ...
  ADD CONSTRAINT `VIAJES_ibfk_4` FOREIGN KEY (`ID_ITINERARIO`) REFERENCES `ITINERARIO` (`ID`),
